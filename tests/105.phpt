...
--SKIPIF--
<?php if (!extension_loaded("geoip") || !geoip_db_avail(GEOIP_ISP_EDITION)) print "skip"; ?>
--POST--
--GET--
--FILE--
<?php
...
var_dump(geoip_isp_by_name('128.100.132.238'));
var_dump(geoip_isp_by_name('www.utoronto.ca'));

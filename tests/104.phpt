...
var_dump(geoip_country_name_by_name(null));
var_dump(geoip_country_name_by_name(''));
...
?>
--EXPECTF--
Notice: geoip_country_name_by_name(): Host  not found in %s
bool(false)

Notice: geoip_country_name_by_name(): Host  not found in %s
bool(false)

Notice: geoip_country_name_by_name(): Host %s not found in %s
bool(false)
